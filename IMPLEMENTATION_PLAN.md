...
**Slice 4** (next) = retrain on the now-position-aware schema + the fail-before-train integrity gate (UTG tighter than BTN, 3-bet 5-15%) + FOLLOW-007 export to arena bridge_v1 + sanity/bb100 validation BEFORE any live deploy.
